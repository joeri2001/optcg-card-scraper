...
def download_image(img_url, img_name):
    ...
    if response.status_code == 200:
        ...
        print(f"Saved image to: images/{img_name}")
...
def scrape_series(series_number):
    ...
    if response.status_code != 200:
        print(f"Failed to retrieve data for series {series_number}")
        return []
    ...
    for card_element in card_elements:
        ...
        image_path = download_image(image_url, f"{card_id}.png") if download_images else f"images/{card_id}.png"
        ...
        cards.append({
            ...
            'class': card_class,
            'name': card_name,
            'image_path': f"images/{card_id}.png",
            'cost': cost,
        ...
        print(f"Scraped card: {card_name} (ID: {card_id}, Number: {card_number})")
...
for series_number in series_numbers:
    print(f"Scraping series {series_number}")
...
print("Scraping completed and data saved to optcg_cards.json")
